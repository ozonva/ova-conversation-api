...
func (m *MockRepo) AddEntities(entities []domain.Conversation) error {
	m.ctrl.T.Helper()
...
func (m *MockRepo) DescribeEntity(entityId uint64) (*domain.Conversation, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepo) ListEntities(limit, offset uint64) ([]domain.Conversation, error) {
	m.ctrl.T.Helper()
